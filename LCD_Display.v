...
module LCD_Display(iCLK_50MHZ,iRST_N,LCD_RS,LCD_E,LCD_RW,DATA_BUS,position,word);
	...
	LCD_display_string u1(CHAR_COUNT,Next_Char,word);

	assign position = CHAR_COUNT;
